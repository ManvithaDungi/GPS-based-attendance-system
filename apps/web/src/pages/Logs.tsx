      ...
      <NeumorphicCard className="p-4">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <select
            ...
            className="bg-bg-light dark:bg-bg-dark neumorphic-inset border-none rounded-xl px-4 py-3 text-xs font-bold text-slate-500 focus:ring-0 sm:w-40"
          >
          ...
          <select
            ...
            className="bg-bg-light dark:bg-bg-dark neumorphic-inset border-none rounded-xl px-4 py-3 text-xs font-bold text-slate-500 focus:ring-0 sm:w-44"
          >
